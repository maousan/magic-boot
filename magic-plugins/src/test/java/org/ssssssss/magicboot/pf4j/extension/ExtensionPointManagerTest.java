...
class ExtensionPointManagerTest {
    ...
    void onPluginStarted_shouldClearCache() {
        ...
        PluginStateEvent event = new PluginStateEvent(pluginWrapper, PluginState.STARTED, PluginState.CREATED);
    ...
    void onPluginStopped_shouldClearCache() {
        ...
        PluginStateEvent event = new PluginStateEvent(pluginWrapper, PluginState.STOPPED, PluginState.STARTED);
