import{H as p,J as e,R as N,Q as z,P as B,aK as V,aL as H,ai as E,av as G,aF as n,bB as K,c1 as J,ce as L,cf as Q,a3 as D,ac as T}from"./index-BrR567x-.js";import{g as W}from"./get-slot-Bk_rJcZu.js";import{g as q}from"./Popover-CZhkcIUl.js";import{d as U}from"./light-Dfcc8GrS.js";function M(t,g="default",d=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const s=i[g];if(typeof s=="function")return s()}return d}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
