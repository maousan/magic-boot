define([
	'./java-class.js', 
	'../parsing/tokenizer.js', 
	'../parsing/index.js', 
	'../parsing/parser.js', 
	'./request-parameter.js', 
	'../parsing/ast.js'], 
function(JavaClass, tokenizer, parsingIndex, parsingParser, RequestParameter, parsingAst) {
    
    // 解构导入
    const { TokenStream } = parsingIndex;
    const { Parser } = parsingParser;
    const { MemberAccess, MethodCall, NewStatement, VariableAccess } = parsingAst;
