...
public class JobMagicDynamicRegistry extends AbstractMagicDynamicRegistry<JobInfo> {

	private final TaskScheduler taskScheduler;

	private static final Logger logger = LoggerFactory.getLogger(JobMagicDynamicRegistry.class);

	private final boolean showLog;

	public JobMagicDynamicRegistry(MagicResourceStorage<JobInfo> magicResourceStorage, TaskScheduler taskScheduler, boolean showLog) {
