    ...
    <div class="magic-file-info">
        <form>
            ...
            <div class="magic-form-row">
                ...
                <magic-select inputable @update:value="handleTypeChange" v-model:value="info.type" width="100%"
                              :options="storageTypeOptions" :placeholder="$i('file.form.placeholder.type')"/>
            </div>
            ...
            <template v-if="info.type === 'local'">
                ...
                <div class="magic-form-row">
                    ...
                    <magic-input v-model:value="properties.domain" placeholder="http://localhost:8081"/>
                </div>
            </template>
            ...
            <template v-if="info.type === 's3' || info.type === 'minio'">
                <div class="magic-form-row">
                    ...
                    <magic-input v-model:value="properties.endpoint"
