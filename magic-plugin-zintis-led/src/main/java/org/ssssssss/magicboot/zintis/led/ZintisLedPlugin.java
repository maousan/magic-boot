...
@Slf4j
public class ZintisLedPlugin extends SpringPlugin {

    private AnnotationConfigApplicationContext applicationContext;

    public ZintisLedPlugin(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    @Override
    public void start() {
        log.info("ZintisLedPlugin started: pluginId={}, version={}",
    ...
    public void stop() {
        ...
        log.info("ZintisLedPlugin stopped");
    }
    ...
    @Configuration
    @ComponentScan(basePackages = "org.ssssssss.magicboot.zintis.led")
